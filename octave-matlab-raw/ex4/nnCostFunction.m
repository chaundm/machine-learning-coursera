...
Matrix1 = Theta1(:,2:end).^2; %Sum of sum of Theta1^2
Matrix2 = Theta2(:,2:end).^2; %Sum of sum of Theta2^2

J = J + lambda/(2*m)*(sum(Matrix1(:)) + sum(Matrix2(:)));
...
%Step3
delta2 = delta3*Theta2(:,2:end).*sigmoidGradient(z2); %delta2 = m x L

%Step4
Delta1 = delta2'*a1; %delta1 L x (n+1)
Delta2 = delta3'*a2; %delta2 K x (L+1)
