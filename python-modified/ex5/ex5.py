...
def plotLearningCurves(lambda_val=1., times=50):
...
print('Plot data with lambda=0.01')
input('Program paused. Press enter to continue.\n')
plotLearningCurves(lambda_val = 0.01)
print('Plot data with lambda=3')
input('Program paused. Press enter to continue.\n')
plotLearningCurves(lambda_val = 3)
input('Program paused. Press enter to continue.\n')
